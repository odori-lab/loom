...
// Generate content page from chunks (new way - supports split posts)
...
// Generate content page from posts (legacy - for backward compatibility)
...
// Legacy function - Threads-style layout (header row + full width content)
