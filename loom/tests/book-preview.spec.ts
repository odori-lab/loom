...
test.describe("BookPreview - Page Navigation & Content Overflow", () => {
  ...
  test("should render initial spread correctly", async ({ page }) => {
    ...
    await page.screenshot({
      path: "test-results/01-initial-spread.png",
      fullPage: true,
    });
  });
  ...
  test("should navigate forward through all spreads", async ({ page }) => {
    ...
    await page.screenshot({
      path: "test-results/02-spread-0.png",
      fullPage: true,
    });
    ...
    for (let i = 1; i < spreadCount; i++) {
      ...
      await page.screenshot({
        path: `test-results/02-spread-${i}.png`,
        fullPage: true,
      });
    }
  });
  ...
  test("should navigate backward correctly", async ({ page }) => {
    ...
    await page.screenshot({
      path: "test-results/03-after-forward-3.png",
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: "test-results/03-after-backward-3.png",
      fullPage: true,
    });
  });
  ...
  test("should handle slider navigation", async ({ page }) => {
    ...
    if ((await slider.count()) > 0) {
      ...
      await page.screenshot({
        path: "test-results/04-slider-middle.png",
        fullPage: true,
      });
      ...
      await page.waitForTimeout(500);
      await page.screenshot({
        path: "test-results/04-slider-last.png",
        fullPage: true,
      });
      ...
      await page.waitForTimeout(500);
      await page.screenshot({
        path: "test-results/04-slider-first.png",
        fullPage: true,
      });
    }
  });
  ...
  test("should check iframe content for overflow", async ({ page }) => {
    ...
    async function checkCurrentSpreadOverflow(spreadIdx: number) {
      ...
      for (let j = 0; j < iframeCount; j++) {
        const overflowResult = await page
          .evaluate(async (idx) => {
  ...
  test("should test keyboard navigation", async ({ page }) => {
    ...
    await page.waitForTimeout(800);
    await page.screenshot({
      path: "test-results/06-keyboard-right.png",
      fullPage: true,
    });
    ...
    await page.waitForTimeout(800);
    await page.screenshot({
      path: "test-results/06-keyboard-right-2.png",
      fullPage: true,
    });
    ...
    await page.waitForTimeout(800);
    await page.screenshot({
      path: "test-results/06-keyboard-left.png",
      fullPage: true,
    });
  });

  test("should verify page count matches spread structure", async ({
    page,
  }) => {
    ...
    await page.screenshot({
      path: "test-results/07-page-spread-verification.png",
      fullPage: true,
    });
  });
});
