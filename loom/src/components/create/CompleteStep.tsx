  ...
  return (
    ...
    >
      ...
      <div className="relative w-24 h-24 mx-auto mb-8">
        <div
          className="absolute inset-0 rounded-full bg-green-200 opacity-25"
          style={{ animation: "cf-ring-expand 1.5s ease-out 0.3s both" }}
        />
        <div
          className="absolute inset-0 rounded-full bg-green-200 opacity-15"
          style={{ animation: "cf-ring-expand 1.5s ease-out 0.6s both" }}
        />
        <div
          className="relative w-24 h-24 rounded-full bg-gradient-to-br from-green-400 to-green-500 flex items-center justify-center shadow-lg"
          style={{ animation: "bounce-in 0.5s ease-out 0.2s both" }}
        >
      ...
      >
        {t("create.complete.title")}
      </h1>
      <p
        className="text-lg text-gray-500 mb-10"
        style={{ animation: "fadeInUp 0.5s ease-out 0.42s both" }}
      >
