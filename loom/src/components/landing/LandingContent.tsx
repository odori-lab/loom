...
function useScrollAnimation() {
  ...
  useEffect(() => {
    ...
    const elements = node.querySelectorAll(
      ".landing-scroll-animate, .landing-scroll-animate-scale, .landing-step-connector",
    );
...
const FEATURES = [
  {
    titleKey: "features.bookFormat.title",
    descKey: "features.bookFormat.description",
    gradient: "from-purple-500 to-pink-500",
    bg: "bg-purple-50",
  },
  {
    titleKey: "features.images.title",
    descKey: "features.images.description",
    gradient: "from-blue-500 to-cyan-500",
    bg: "bg-blue-50",
  },
  {
    titleKey: "features.filter.title",
    descKey: "features.filter.description",
    gradient: "from-green-500 to-emerald-500",
    bg: "bg-green-50",
  },
  {
    titleKey: "features.engagement.title",
    descKey: "features.engagement.description",
    ...
    >
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <div
            className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-200 rounded-full blur-3xl opacity-30"
            data-parallax="-0.1"
            style={{ animation: "landing-float-slow 8s ease-in-out infinite" }}
          />
          <div
            className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-200 rounded-full blur-3xl opacity-30"
            data-parallax="-0.08"
            style={{
              animation: "landing-float-delayed 10s ease-in-out infinite 2s",
            }}
          />
        </div>
          ...
          <Link
            href={
              user
                ...
                : "/login?redirect=/dashboard?tab=create"
            }
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {STEPS.map((item, index) => (
              <div
                key={item.step}
                className={`relative group landing-scroll-animate landing-stagger-${index + 1}${index < 2 ? " landing-step-connector" : ""}`}
              >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {FEATURES.map((feature, i) => (
              <div
                key={i}
                className={`group p-6 bg-white rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all landing-feature-card landing-scroll-animate landing-stagger-${i + 1}`}
              >
                <div
                  className={`w-12 h-12 mb-5 rounded-xl ${feature.bg} flex items-center justify-center landing-feature-icon`}
                >
                  <div
