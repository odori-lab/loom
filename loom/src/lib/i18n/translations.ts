...
export const translations = {
  ko: {
    ...
    "hero.description":
      "Threads 포스트를 전문적으로 포맷된 PDF로 변환하세요. 생각을 저장하고, 이야기를 공유하고, 나만의 책을 만드세요.",
    "hero.cta": "Loom 만들기",
    ...
    "howItWorks.step1.description":
      "Threads 사용자명을 입력해서 포스트를 가져오세요",
    "howItWorks.step2.title": "포스트 선택",
    "howItWorks.step2.description":
      "포함할 포스트를 선택하고, 날짜로 필터링하고, 순서를 정하세요",
    "howItWorks.step3.title": "PDF 다운로드",
    "howItWorks.step3.description":
      "아름답게 포맷된 A5 PDF를 받아 읽거나 인쇄하세요",

    // Features
    "features.title": "기능",
    "features.bookFormat.title": "책 형식",
    "features.bookFormat.description":
      "편안한 독서를 위해 적절한 마진과 타이포그래피로 디자인된 A5 사이즈",
    "features.images.title": "이미지 포함",
    "features.images.description": "포스트의 사진이 PDF에 자동으로 포함됩니다",
    "features.filter.title": "필터 & 정렬",
    "features.filter.description":
      "날짜 범위로 필터링하고, 포스트를 검색하고, 최신순 또는 오래된순으로 정렬",
    "features.engagement.title": "참여 통계",
    "features.engagement.description":
      "전체 맥락을 담기 위해 좋아요와 답글 수가 보존됩니다",
    ...
    "login.terms":
      "계속하면 서비스 약관 및 개인정보 처리방침에 동의하는 것입니다",
  ...
  en: {
    ...
    "hero.description":
      "Transform your Threads posts into a professionally formatted PDF. Save your thoughts, share your stories, or print your own book.",
    ...
    "howItWorks.step1.description":
      "Enter any Threads username to fetch their posts",
    "howItWorks.step2.title": "Select Posts",
    "howItWorks.step2.description":
      "Choose which posts to include, filter by date, and arrange the order",
    "howItWorks.step3.title": "Download PDF",
    "howItWorks.step3.description":
      "Get a beautifully formatted A5 PDF, ready to read or print",

    // Features
    "features.title": "Features",
    "features.bookFormat.title": "Book-like Format",
    "features.bookFormat.description":
      "A5 size with proper margins and typography designed for comfortable reading",
    "features.images.title": "Images Included",
    "features.images.description":
      "Photos from your posts are automatically included in the PDF",
    "features.filter.title": "Filter & Sort",
    "features.filter.description":
      "Filter by date range, search posts, and sort newest or oldest first",
    "features.engagement.title": "Engagement Stats",
    "features.engagement.description":
      "Likes and reply counts are preserved to capture the full context",

    // CTA
    "cta.title": "Ready to create your Loom?",
    "cta.description":
      "Start transforming your Threads posts into a beautiful book today.",
